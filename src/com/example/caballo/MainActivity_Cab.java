...
public class MainActivity_Cab extends Activity {
	...
	public void crearMenu(Menu menu) {
		...
		MenuItem record = menu.add(0, 1, 1, "SCORE");
		{
	...
	public void viewB(View v) {
		...
		if (vista) {
			...
			pintarCaballo();
			text0.setText("POSICION FINAL");
			vista = false;

			((ImageView) findViewById(R.id.view))
					.setImageResource(R.drawable.retun);
			((TextView) findViewById(R.id.viewtext)).setText("Return");
			...
			((TextView) findViewById(R.id.viewtext)).setText("View");
		}
